...
if shuttle:
    ...
    if check_level:
        ...
        mas_string = '<strong><em>Your maximal aerobic speed (MAS), the speed you were running at when the test ended, is <span style="color:#F63366;"> ' + "%.1f" % mas + ' km h\u207B\u00B9</span></em></strong>'
